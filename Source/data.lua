...
if not leighzermods.leighzerscienceores then
    ...
    leighzermods.leighzerscienceores.tints.logistic = {r=149/255, g=206/255, b=129/255, a = 1}
    leighzermods.leighzerscienceores.tints.military = {r=135/255, g=146/255, b=155/255, a = 1}
    leighzermods.leighzerscienceores.tints.chemical = {r=97/255, g=216/255, b=234/255, a = 1}
    leighzermods.leighzerscienceores.tints.production = {r=152/255, g=26/255, b=202/255, a = 1}
    leighzermods.leighzerscienceores.tints.utility = {r=208/255, g=177/255, b=20/255, a = 1}
    leighzermods.leighzerscienceores.tints.space = {r=222/255, g=222/255, b=222/255, a = 1}
